...
<a href="https://github.com/Nazarchykushka/LinuxPackageInstaller/releases/latest">
...
As the program is only in pre-release stage, the author does not accept any donations. But all the translations except Ukrainian, Russian and English were partially made by AI, so if you know other languages, you can suggest improvements or describe program bugs on . You can download the reference translation file [here](https://github.com/Nazarchykushka/LinuxPackageInstaller/blob/main/translations_reference.ts) if your language is untranslated. To ensure it works, download the source code, add your `.ts` file to the `translations` folder and compile the program. 

## Support

Since the program is currently in the pre-release stage, the author is not accepting donations at this time. However, you can support the project by improving its localization or reporting bugs. Currently, only the Ukrainian, Russian, and English translations are fully verified. All other languages were partially generated by Gemini and may contain inaccuracies.

How you can help:

  Improve existing translations: If you notice mistakes, please suggest corrections. 

  Add new languages: If your language is missing, download the reference translation file, translate it, and attach it to a new [issue](https://github.com/Nazarchykushka/LinuxPackageInstaller/issues). To verify your translation, place the new .ts file into the translations folder and compile the program from source.

  Report bugs: Describe any technical issues you encounter on the [issues](https://github.com/Nazarchykushka/LinuxPackageInstaller/issues) page.

If you know other languages or find any bugs, your contribution would be greatly appreciated!
