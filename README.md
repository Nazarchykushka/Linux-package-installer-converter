...
**If you want to compile/build this program by yourself**

  - To build the program itself:
    1. Install cmake
    2. Install qt6-languageserver qt6-tools vulkan-devel and required packages
    3. cd /PackageInstaller/build/Desktop-Debug/
    4. Run cmake ../..
    5. Run cmake --build PackageInstaller/build/Desktop-Debug/ --target all
  - To build the installer
    1. Build the program itself
